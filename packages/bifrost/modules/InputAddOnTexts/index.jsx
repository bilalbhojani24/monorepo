...
const InputAddOnTexts = forwardRef(
  (
    ...
    <div className="bifrost-input-field">
      ...
      <div
        className={twClassNames('mt-1 rounded-md shadow-sm', {
      ...
      >
        ...
        <input
          ...
          className={twClassNames(
            ...
            (leadingAddOnText || trailingAddOnText) && !isAddOnInline
              ? ['min-w-0 flex-1']
            ...
            isAddOnInline
              ? [
                  'rounded-md py-2',
                  {
                    'pl-16 rounded-r-md': leadingAddOnText,
                    'pr-16': trailingAddOnText
                  }
                ]
              : [
                  {
        ...
        {trailingAddOnText && (
          ...
          >
            <span className="text-base-500 sm:text-sm">
              {trailingAddOnText}
            </span>
          </div>
        )}
