...
export const ELEMENTS_WITH_LABEL = [
  {
    ...
    icon: (
      <MdPersonAddAlt1 className="text-base-400 group-hover:text-base-100 h-5 w-5" />
    ),
  ...
  },
  {
    ...
    icon: <MdHelp className="text-base-400 group-hover:text-base-100 h-6 w-6" />
  },
  {
    name: 'account',
    icon: (
  ...
  },
  {
    name: 'notifications',
    icon: (
      <MdNotifications className="text-base-400 hover:text-base-100 h-6 w-6" />
    )
  },
  {
    name: 'search',
    icon: <MdSearch className="text-base-400 hover:text-base-100 h-6 w-6" />,
