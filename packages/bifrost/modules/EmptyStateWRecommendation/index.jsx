    ...
    <div className={classNames('mx-auto', wrapperClassName)}>
      <div>
        <div className="text-center">
          ...
          <h2 className="mt-2 text-lg font-medium text-gray-900">{heading}</h2>
      ...
      <div className="mt-10">
        <h3 className="text-sm font-medium text-gray-500">{recommendationTitle}</h3>
        <ul
          role="list"
          className={classNames('mt-4', {
            'divide-y divide-gray-200 border-t border-b border-gray-200': LAYOUT_TYPES[1] === layout,
