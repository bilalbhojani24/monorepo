...
const NotebookIcon = ({ iconClass }) => (
  <svg
    ...
    className={iconClass}
  >
    <g clipPath="url(#clip0_5129_83957)">
      <path d="M13 5H9.5V6H13V5Z" fill="black" />
      <path d="M13 7.5H9.5V8.5H13V7.5Z" fill="black" />
      <path d="M13 10H9.5V11H13V10Z" fill="black" />
      <path
