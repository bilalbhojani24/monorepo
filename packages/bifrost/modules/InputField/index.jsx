...
import { useCaptureDimension } from './useCaptureDimension';
...
const InputField = forwardRef(
  (
    ...
    const leadingIconRef = useRef();
    const trailingIconRef = useRef(null);

    const { width: trailingWidth } = useCaptureDimension(trailingIconRef);
    const { width: leadingWidth } = useCaptureDimension(leadingIconRef);
      ...
      <div>
        ...
        >
          ...
          <input
            ...
            style={{
              paddingRight: `${trailingWidth + 2}px`,
              paddingLeft: `${leadingWidth + 2}px`
            }}
          />
          <div
            ref={trailingIconRef}
