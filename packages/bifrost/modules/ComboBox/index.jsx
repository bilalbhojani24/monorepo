  ...
  return (
    ...
    >
      ...
      <div className="relative mt-1">
        <Combobox.Input
          className="w-full rounded-md border border-base-300 bg-white py-2 pl-3 pr-10 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500 sm:text-sm"
              ...
              <Combobox.Option
                ...
                className={({ active }) =>
                  classNames(
                    ...
                    active && !isMulti ? 'bg-indigo-600 text-white' : 'text-base-900',
                    {
