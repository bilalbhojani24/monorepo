  ...
  return (
    ...
    >
      <path
        ...
        className={twClassNames('origin-center animate-spin', {
          'fill-base-500': isHoverActive,
          'fill-base-400': !isHoverActive
        })}
      />
      <path
        d="M0 0V5L4.25 7.52L5.02 6.24L1.5 4.15V0H0Z"
        className={isHoverActive ? 'fill-base-500' : 'fill-base-400'}
        style={{
          fillOpacity: 1,
          fillRule: 'evenodd',
          stroke: 'none'
