...
// const ImportStatus = ({ status, importId, isDismissed }) => {
...
//     console.log('check import status handler', latestImportConfig?.status);
//     getQuickImportStatus(importId).then((data) => {
//       console.log('get quick import status', data);
...
//     //   }
//     // );
//     if (!isDismissed && status !== ONGOING) checkImportStatusClickHandler();
//     // eslint-disable-next-line react-hooks/exhaustive-deps
//   }, [status]);
...
//   //   'import config',
//   //   latestImportConfig.importId,
//   //   latestImportConfig.status,
//   //   latestImportConfig.isDismissed
//   // );
//   const showRibbonNotification = status === ONGOING;
