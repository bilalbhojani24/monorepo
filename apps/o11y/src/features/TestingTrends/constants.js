...
export const TREND_CARDS_LAYOUT = {
  ...
  lg: [
    { w: 10, h: 3, x: 0, y: 0, i: 'latestUniqueBuildRuns', minW: 10, minH: 3 },
    { w: 5, h: 3, x: 0, y: 6, i: 'alwaysFailing', minW: 5, minH: 3 },
    { w: 5, h: 3, x: 6, y: 6, i: 'newFailures', minW: 5, minH: 3 },
    { w: 5, h: 3, x: 6, y: 3, i: 'flakiness', minW: 5, minH: 3 },
    { w: 5, h: 3, x: 0, y: 3, i: 'failureCategories', minW: 5, minH: 3 },
    { w: 10, h: 3, x: 0, y: 12, i: 'stability', minW: 10, minH: 3 },
    { w: 10, h: 3, x: 0, y: 15, i: 'performance', minW: 10, minH: 3 },
    { w: 5, h: 3, x: 0, y: 9, i: 'buildRunFrequency', minW: 5, minH: 3 },
    { w: 5, h: 3, x: 6, y: 9, i: 'testGrowthOverTime', minW: 5, minH: 3 },
    { w: 5, h: 3, x: 0, y: 12, i: 'testExecutions', minW: 5, minH: 3 },
    { w: 5, h: 3, x: 0, y: 15, i: 'cbt', minW: 5, minH: 3 },
    { w: 5, h: 3, x: 0, y: 18, i: 'parallelExecutions', minW: 5, minH: 3 }
  ],
  sm: [
