...
export const PUSHER_EVENTS = {
  ...
  SMART_TAG_RECALCULATION_STARTED: 'SMART_TAG_RECALCULATION_STARTED',
  SMART_TAG_RECALCULATION_COMPLETED: 'SMART_TAG_RECALCULATION_COMPLETED',
  BUILD_ARCHIVED: 'BUILD_ARCHIVED'
};
